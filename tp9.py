...
class TestFraction(TestCase):
    ...
    def test_init(self):
        ...
        with self.assertRaises(ValueError, msg="denominator ne peut pas être 0"):
            Fraction(1, 0)
        ...
        f1 = Fraction(10**6, 1)
        self.assertEqual(f1.numerator, 10**6, "numerator très grand")
        self.assertEqual(f1.denominator, 1, "denominator tres grand")

        f2 = Fraction(1, 10**6)
        self.assertEqual(f2.numerator, 1, "numerator très petit")
        self.assertEqual(f2.denominator, 10**6, "denominator tres petit")
